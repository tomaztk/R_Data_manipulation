...
# Logical Operators in R programming language work only for the basic 
# data types logical, numeric and complex and vectors of these basic data types.
...
# subseting specific rows and columns
df_subset <- df[df$Indeks > 90, c("Ime", "Indeks")]
print(df_subset)

help(subset)

# Subseting by using subset() function for filtering
df_subset <- subset(df, Starost < 35)  
print(df_subset)


df[df$Starost > 25 & df$Indeks > 90, ]

# Subseting by using two filter conditions Age and Index - ANDing
