...
Quarto can render Jupyter notebooks represented as plain text (.qmd) or as a normal notebook file (.ipynb). The [Quarto VS Code Extension](https://marketplace.visualstudio.com/items?itemName=quarto.quarto) includes many tools that enhance working these documents. You can also convert between .ipynb and .qmd representations of a notebook using the [quarto convert command](https://quarto.org/docs/tools/jupyter-lab.html#converting-notebooks).
